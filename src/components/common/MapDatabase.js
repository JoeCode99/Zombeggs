const MapDatabase = new Map([
    ['IX', {steps: [
      ...
      ["Mauer_Der_Toten", {steps: [
        ["Follow the on-screen prompts to turn on the power and enable the Pack-a-Punch"],
        ["Build and Upgrade Klaus",
          "Kill a Krasny Soldat and pick up the dropped battery",
          "Head to the 'Death Strip' and search throught the debris piles for a microwave dish :::pile.png :::microwave_dish.png",
          "Go the the Garment Factory and place the dish into the upgrade station :::place_md.png",
          "Get the brain rot attachment and head to Hotel Room 305 to knock down the barrier :::brain_rot_zomb.png",
          "Pick up the robot hands on the bed :::robot_hands.png",
          "Head back to Klaus and activate him :::activate_klaus.png",
          "Take him to the Garment Factory and let him get zombie kills. Wait until the top right screen on the upgrade station turns green :::monitor_green.png",
          "Direct Klaus into the upgrade station and defend him :::upgrading.png",
        ],
        ["Obtain the wonder weapon (steps here for the guaranteed one)",
          "Direct Klaus to the Switch Control Room to open this locker :::locker_room.png",
          "Obtain the blacklight from the locker :::light.png",
          "Head to the Garment Factory and scan the surrounding area with the blacklight for some numbers. Write them down :::gf1.png :::numbers.png",
          "Do the same in the Service Passage and Grocery Store locations",
          "With your numbers, go to Hotel Room 305 and enter the combination into the safe :::safe.png",
          "Obtain your free wonder weapon"
        ],
        ["Head to Sewer Access and direct Klaus to the wall in the back of the room",
          "It is located here :::wall_klaus.png",
          "Once it is destroyed, obtain a Blazer Mod Kit and use it to break down the metal wall layer :::blazer_kit.png :::break_down.png",
          "End the round to disable the red shields :::red_shield.png"
        ],
        ["Pick up the cylinders that appear from the central console", 
          "Obtain them from here: :::cylinders.png"
        ],
        ["You want to place each cylinder into 3 seperate harvesters. The seven possible locations are provided below",
          "Sewer Access :::sa.png",
          "West Berlin Street :::wbs.png",
          "Ghost Station :::gs.png",
          "Destroyed Penthouse :::dp.png",
          "Alley :::alley.png",
          "Korber Rooftop :::kr.png",
          "East Berlin Streets :::ebs.png",
        ],
        ["Once you place the cylinder in each, head back to the secret lab and obtain an Endstation Lure",
          "Shoot this drawer with your wonder weapon to obtain it: :::sl.png",
          "Throw them near the harvesters and kill the tempests :::harv.png",
          "Keep repeating this entire step until the cylinder inside the harvester glows bright purple",
          "Place the glowing purple cylinder back in the Secret Lab where you found them :::put_back.png"
        ],
        ["Obtain the nuclear warhead", 
          "Head to the Switch Control Room and turn the lever :::switch_room.png",
          "Direct Klaus to the train track here and let him stop the train :::train_klaus.png",
          "Obtain the bomb and keycard from the train"
        ],
        ["Build the headgear for Klaus", 
          "Go to the spawn apartment rooftop and shoot this tower: :::tower.png",
          "Pick up the antenna that drops :::antenna.png",
          "Head to Ghost Station and shoot this box with your wonder weapon :::box_ww.png",
          "Pick up the electronic boards :::eboards.png",
          "Head to the Electronics Store and shoot the radios with your wonder weapon until a part drops :::radio.png",
          "Head back to Klaus and upgrade him :::head_klaus.png",
        ],
        ["Head to the computer in the Safe House and keep browsing files until you can activate the satellite",
          "The computer: :::computer1.png",
          "Head to the high value target area and keep on killing until 2 uranium rocks drop",
          "Pick up the uranium and head to this workbench near the Pack-a-Punch :::uranium_up1.png",
          "Place it on either end of the Korber Rooftop zipline :::korber.png :::other_end.png",
          "Do the same for the second piece of uranium",
          "Pick up the cleansed rock and take it to the Secret Lab to place here :::cleansed.png",
          "Push the next round, and repeat the above steps but start it from this computer instead :::computer2.png",
          "Optionally, head to the crafting bench in the Military Tent for the uranium instead",
          "Once this is done the boss fight will be activated"
        ],
        ["BOSS FIGHT",
          "Pretty simple, shoot until its over :::boss.png"
        ]
      ], sources: "MrDalekJD", minPlayers: 1}]
])
